...
import com.example.win.easy.activity.component.SongAdapter;
import com.example.win.easy.activity.component.SongListAdapter;
import butterknife.BindView;


public class AppListOne extends AppCompatActivity {
    //测试控件
    @BindView(R.id.btn_io)Button btn_io;//模拟后台读入图片
    @BindView(R.id.btn_picLoaded) Button btn_picLoaded;//模拟更改LiveData从而通知刷新图片
    @BindView(R.id.btn_exchange) Button btn_exchange;//模拟后台更新列表播放次数
    @BindView(R.id.btn_SongListTimes) Button btn_SongListTimes;//模拟后台更新歌曲播放次数
    @BindView(R.id.btn_SongLoad) Button btn_SongLoad;//模拟后台完成歌曲下载

    /*……后期可制为底边栏*/
    @BindView(R.id.btn_back) Button btn_back;
    @BindView(R.id.btn_songlist) Button btn_songlist;
    @BindView(R.id.btn_songs) Button btn_songs;

    @BindView(R.id.etx_songlist) EditText etx_songlist;//搜索
 ...
 /****测试控件初始化****/
        //【歌曲】
//        btn_SongLoad.setOnClickListener(v -> {//模拟后台完成歌曲下载
...
//        });
//
//        btn_exchange.setOnClickListener(v -> {//模拟后台更新了歌曲的播放次数
//            if(listView.getAdapter() instanceof SongAdapter){
...
/****测试控件初始化结束****/
    ...
    /*******************初始化界面控件******************/
    void init_ctl(){
        btn_songs.setOnClickListener(v -> {
        ...
        btn_songlist.setOnClickListener(v -> {
...
//        mViewModel.getSongListPicDownLoadState().observe(AppListOne.this, mDownLoaded -> {
//            if(mDownLoaded) {
...
//        mViewModel.getSongListReplayTimes().observe(AppListOne.this, atrr -> {
//            SongListAdapter songListAdapter=(SongListAdapter)listView.getAdapter();
...
//        mViewModel.getCurDownloadedSong().observe(AppListOne.this, integer -> {
//            if (listView.getAdapter() instanceof SongAdapter) {
...
//        mViewModel.getSongReplayTimes().observe(AppListOne.this, atrr -> {
//            if (listView.getAdapter() instanceof SongAdapter){
//                SongAdapter songAdapter = (SongAdapter) listView.getAdapter();
